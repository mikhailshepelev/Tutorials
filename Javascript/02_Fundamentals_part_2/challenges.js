...
function calcTip(value) {
    return value >= 50 && value <= 300 ? 0.15 : 0.2;
}
...
if (mark.calcBMI() > john.calcBMI()) {
    ...
    console.log(`${john.fullName}'s and ${mark.fullName}'s BMI's are equal (${john.bmi})!`)
}
...
for (let i = 0; i < billsArr.length; i++) {
    tipsArr.push(calcTip(billsArr[i]) * billsArr[i]);
...
console.log(calcAverageArr(tipsArr));
